...
class MTCNN(nn.Module):
    ...
    def __init__(
        self, pnet_path, rnet_path, onet_path,  image_size=160, margin=0, min_face_size=20,
        ...
        self.pnet = PNet(state_dict_path=pnet_path)
        self.rnet = RNet(state_dict_path=rnet_path)
        self.onet = ONet(state_dict_path=onet_path)
    ...
    def forward(self, img, save_path=None, return_prob=False):
        ...
        with torch.no_grad():
            ...
            # print('batch_boxes={}'.format(batch_boxes))
            # print('batch_probs={}'.format(batch_probs))
        return batch_boxes    
...
class MTCNNdetector:
    def __init__(self, cfg):
        ...
        self.model = MTCNN(
            pnet_path = cfg['path_pnet'],
            rnet_path = cfg['path_rnet'],
            onet_path = cfg['path_onet'],
    ...
    def run(self, image):
        res = self.model.detect(image, landmarks=True)
        return(res)
